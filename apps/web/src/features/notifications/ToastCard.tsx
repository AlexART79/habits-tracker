...
export function ToastCard({ notification, onAck }: ToastCardProps) {
  return (
    <div
      role="status"
      className="flex items-start gap-3 bg-white dark:bg-gray-800 border border-gray-200 dark:border-gray-700 rounded-xl shadow-lg px-4 py-3 w-80"
    >
      <span className="text-2xl leading-none mt-0.5">🏆</span>
      <div className="flex-1 min-w-0">
        <p className="text-sm font-semibold text-gray-900 dark:text-gray-50 truncate">{notification.habitName}</p>
